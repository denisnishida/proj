...
<?php include ("templates/header.php") ?>
    <section>
        <?php if ($showPermission == 1): ?>
            <p><a href="signin/Register">Add New User</a></p>
        <?php endif; ?>
        <?php if ($showPermission == 1): ?>
            <table class="table">
                <thead>
                    <tr>
                        <th><a href="manageusers/Username">Username</a></th>
                        <th><a href="manageusers/FirstName">First Name</a></th>
                        <th><a href="manageusers/LastName">Last Name</a></th>
                        <th><a href="manageusers/DateCreated">Date Created</a></th>
                        <th><a href="manageusers/PermissionType">Permission Type</a></th>
                    </tr>
                </thead>
                <tbody>
